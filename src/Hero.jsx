...
const Hero = () => {
  ...
  return (
    <section
      className="relative w-full h-[100vh] font-montserrat overflow-hidden"
      id="home"
    >
      {/* 🔹 Background Image (faded) */}
      <div
      ...
      {/* 🔹 Blue Overlay */}
      <div
        className="absolute inset-0 bg-[#0C1A3A] z-0"
        style={{ opacity: "40%" }}
      ></div>
      ...
      <div className="relative z-10">
        ...
        {/* 🧱 Hero Content */}
        <div
          className="h-[calc(100vh-80px)] flex items-center px-6 md:px-20"
          data-aos="fade-up"
        >
          <div className="max-w-xl text-left space-y-6 text-white">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
            ...
            <p className="text-sm leading-relaxed">
              Bringing Ideas to Life with Design, Code,
              <br />
              and &nbsp; Customer Care — All in One Lab!
            </p>
            <p className="text-sm">
              At{" "}
              <span className="font-semibold text-blue-300">Pixe Lab</span>, we
              empower businesses with innovative solutions. Our team of experts
              designs, develops, and supports cutting-edge technology. From
              concept to launch, we’re with you every step of the way.
            </p>
            <button className="common hov text-white text-sm px-6 py-2 max-w-[200px] rounded-md transition">
              Let’s Innovate →
            </button>
          </div>
        </div>
